...
let dcontador = description.value.length;
    function contar() {
        if (dcontador <= 20) {
            p.innerText = "La descripción del producto debe tener minimo 20 caracteres "
            p.style.color = "red";
        }
    }
    ...
    function validateFile() 
        {
            ...
            let fileExtension = document.getElementById('productImg').value.split('.').pop().toLowerCase();
